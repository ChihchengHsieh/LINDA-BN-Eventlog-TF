...
class ValidaTraceTransformerEncoder(tf.keras.Model):
    def __init__(self, vocab: VocabDict, num_layers, d_model, num_heads, dff, vocab_size,
                pe_input, rate=0.1):
        super(ValidaTraceTransformerEncoder, self).__init__()
        self.vocab = vocab
        self.tokenizer = ValidTraceEncoder(num_layers, d_model, num_heads, dff,
...
class ValidTraceEncoder(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size,
                 maximum_position_encoding, rate=0.1):
        super(ValidTraceEncoder, self).__init__()
        ...
        self.enc_layers = [ValidTraceEncoderLayer(d_model, num_heads, dff, rate)
...
class ValidTraceEncoderLayer(tf.keras.layers.Layer):
    def __init__(self, d_model, num_heads, dff, rate=0.1):
        super(ValidTraceEncoderLayer, self).__init__()
