...
from Parameters.CommonTrainingParameters import LossSetting, OptimizerSetting, TrainingSetting
from Utils.Preprocessing import dataset_split
from typing import List, Tuple

import pandas as pd
from CustomExceptions.Exceptions import NotSupportedError
from Parameters.Enums import SelectableLoss, SelectableLrScheduler, SelectableModels, SelectableOptimizer
...
class ModelTrainingController(object):
    ...
    def train(
        ...
        while self.not_end():
            print_big("Start epoch %d" % (self.current_epoch))
    ...
    def train_start_print(self):
        print_big("Total epochs: %d" % (self.parameters.stop_epoch))
